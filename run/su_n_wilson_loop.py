...
num_sites: The number of sites along each axis of the lattice. Each axis
...
def main():
    ...
    truncation_irreps, singlets, conj_dict = irreps_and_singlets(
        N, sites, truncation_mode, cutoff
    )

    if generate_plaq_states:
        plaq_states = physical_plaquette_states(
    ...
    matrix_elems = calc_plaquette_elements(
        N,
        plaq_site_plane,
        sites,
        plaquettes,
